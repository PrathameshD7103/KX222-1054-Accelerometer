...
const int sdi = 51;
const int sdo = 50;
//int xar[3800]={};                                                               //Unconmment this line in order to enable x axis buffer array for storing values 
//int yar[3800]={};                                                               //Unconmment this line in order to enable y axis buffer array for storing values
int zar[3800]={};
...
//        int yg=y*0.00024*10000;                           
        int z = (readRegister(0x0B)*256) + readRegister(0x0A);                         //This is for getting 1 16-bit value from 2 8-bit values of LOW and HIGH registers
        int zg=z*0.00024*10000;                                                        //As the datatype is not float the value is multiplied by 10k to accomodate 4 decimal places                 
//        xar[i]=xg;
//        yar[i]=yg;
